...
/**
 * @ORM\Entity(repositoryClass="EgioDigital\CMSBundle\Repository\PageRepository")
...
class Page
{
   ...
   /**
    * @var File|null
    * @Vich\UploadableField(mapping="pages", fileNameProperty="bannerDesktop")
    * @Assert\File(
   ...
   /**
    * @var File|null
    * @Vich\UploadableField(mapping="pages", fileNameProperty="bannerMobile")
    * @Assert\File(
    *    mimeTypes={"image/jpeg", "image/jpg", "image/png"},
    *    maxSize="3M",
    * )
   ...
   /**
    * @ORM\OneToMany(targetEntity="EgioDigital\CMSBundle\Entity\Block", mappedBy="page", orphanRemoval=true, cascade={"persist"})
