...
/**
 * @ORM\Entity(repositoryClass="App\Repository\FondTypeRepository")
 */
class FondType
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Fond", mappedBy="fondType")
     */
    private $fonds;
    ...
    public function removeFond(Fond $fond): self
    {
        if ($this->fonds->contains($fond)) {
            ...
            if ($fond->getFondType() === $this) {
                $fond->setFondType(null);
            }
        }
